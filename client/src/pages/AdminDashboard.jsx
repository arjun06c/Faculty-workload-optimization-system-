...
const AdminDashboard = () => {
    ...
    return (
        <div className="page-container" style={{ background: '#f0f4f8', minHeight: '100vh', padding: '2rem' }}>
            {/* Styled Header */}
            <header style={{
                display: 'flex',
                        ...
                        <table style={{ width: '100%', borderCollapse: 'separate', borderSpacing: '0 10px' }}>
                            ...
                            <tbody>
                                {facultyList.length > 0 ? facultyList.map(f => (
                                    ...
                                    <tr><td colSpan="4" style={{ textAlign: 'center', padding: '2rem', color: '#94a3b8' }}>No faculty records found for the selection.</td></tr>
                                )}
                            </tbody>
                        </table>
                    </div>
            ...
            {view === 'roles' && (
                <div className="card" style={{ padding: '2rem' }}>
                    ...
                    <div style={{ marginTop: '2rem' }}>
                        ...
                        <form onSubmit={handleAddAcademics} style={{ display: 'flex', gap: '1rem', maxWidth: '600px' }}>
                            <input
                                type="email"
                                className="input-field"
