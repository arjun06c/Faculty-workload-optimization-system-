        ...
        <div className="page-container" style={{ background: '#f8fafc', minHeight: '100vh' }}>
            <div className="card flex-between-center" style={{ marginBottom: '2rem', padding: '1.5rem 2rem', borderLeft: '5px solid var(--primary)' }}>
                ...
                <div style={{ textAlign: 'right' }}>
                    {loading ? (
                        <div className="animate-pulse flex flex-col items-end space-y-2 bg-slate-50 p-2 rounded">
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: '1.5rem' }}>
                    {loading ? (
                        Array.from({ length: 6 }).map((_, i) => (
                            <div key={i} className="animate-pulse flex flex-col gap-4 p-6 border border-slate-200 rounded-lg bg-white shadow-sm">
